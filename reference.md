...
- [Playハンズオン](https://github.com/nextbeat-dev/scala-play_handson)
- [Slickチートシート](https://github.com/bizreach/slick-reference/blob/master/3.x.md)

## AWS
- [QWIKLABS(実践的に学べるハンズオンサイト)](https://www.qwiklabs.com/)
